...
- [x] 0.8b-spec [CLOUD-OK] Transcribed the FULL v16 _save_dict schema
      (55 keys in order, types, defaults, load coercions) + game_state.gd
      field/signal/method inventory into ue/PORT-NOTES-STATE.md — the
      0.8b implementation checklist. Cross-check vs 0.8a C++ found 5
      wrong-typed save fields, 32 missing keys, an items_lost cap of 6
      (spec: 7) — filed as §9 boxes 9.1–9.10 for 0.8b-2 (cloud session,
      verified by scripted extraction + assert)
